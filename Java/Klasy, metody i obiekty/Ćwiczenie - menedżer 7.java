...
// camp
    void camp ( int shootingSkill, int passingSkill, int defenceSkill ) {
        if(this.shootingSkill + shootingSkill > 100)this.shootingSkill = 100;
        else this.shootingSkill += shootingSkill;

        if(this.passingSkill + passingSkill > 100)this.passingSkill = 100;
        else this.passingSkill += passingSkill;

        if(this.defenceSkill + defenceSkill > 100)this.defenceSkill = 100;
        else this.defenceSkill += defenceSkill;
    }
}
